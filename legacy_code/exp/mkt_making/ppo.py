...
class PPO:
    ...
    def train(self, itr = None):
        ...
        obj_share = 3
        self.env.set_objective(share= obj_share, remained_time= 1)
        ...
        while True:
            ...
            for i in range(self.max_local_step):
                ...
                next_ob, reward, next_terminal, di = self.env.step(action)
                acc_mkt_value += di['net_mkt_val']
                step += 1
                ...
                if terminal:
                    ...
                    self.env.set_objective(share=obj_share, remained_time=1)
                    print(f'acc mkt val: {acc_mkt_value}')
                    acc_mkt_value = 0
                    observation = self.env.reset()
                    # print(ob)
