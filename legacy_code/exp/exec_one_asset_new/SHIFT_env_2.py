...
class SHIFT_env:
    def __init__(self,
        ...
        self._cols = ['remained_shares', 'remained_time', 'reward',
                      'order_type','is_buy', 'premium',
        ...
        self.tmp_obs = [None]*2
        self.name = 'exec_one_asset_naive'
    ...
    def _get_obs(self):
        self.tmp_obs = np.array([self.remained_share, self.remained_time])
